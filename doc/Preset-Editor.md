# Mini-Moon Preset Editor (JSON Only)

This editor supports creating, editing, loading, and saving Mini-Moon presets in **JSON format only**. Lua support has been fully removed.
